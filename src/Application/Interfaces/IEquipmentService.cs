...
namespace Application.Interfaces
{
    public interface IEquipmentService
    {
        ...
        public Task<Result<PagedList<EquipmentResponse>>> GetFilteredAndSortedEquipment(string? category, string? searchString, string sortBy, SortOrder sortOrder, int page, int pageSize);
